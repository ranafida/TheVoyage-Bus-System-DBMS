...
$tripID = $_GET['driverID'];

$sql1 = "SELECT driver_id FROM trips WHERE trip_id = '$tripID'";
...
$Driver_id = $row1['driver_id'];
 ...
 //$sql = "SHOW TABLES"; 
$sql = "SELECT driverID,busID,drivingType,email FROM driver WHERE driverID = '$Driver_id'";
...
echo "<tr><td>" . $row['driverID'] . "</td><td>". $row['busID'].  "</td><td>".$row['drivingType'].  "</td><td>".$row['email'];
