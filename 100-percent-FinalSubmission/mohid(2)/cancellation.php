...
$sql = "DELETE ticket FROM ticket INNER JOIN trips ON ticket.trip_id = trips.trip_id WHERE trips.status='Upcoming' and ticket.ticket_id='$tickID'";
...
if (mysqli_query($conn, $sql)) {
    $new1 = "Cancellation successfull";
    echo '<div class="my-class">'.$new1.'</div>';
  } 
else {
    $new1 = "Error updating record: ";
    echo '<div class="my-class">'. $new1 . mysqli_error($conn) . '</div>';
}
