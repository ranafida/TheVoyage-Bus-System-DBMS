...
$sql = "INSERT INTO `Bus` (ID,Bus_type,Liscense_no,Assigned_driver,condition_or,recent_trips,Bus_capacity,Fuel_condition,state,petrol,maintenance,cost) VALUES ('$ID', '$Bus_type', '$Liscense_no', '$Assigned_driver', '$condition_or', '$recent_trips', '$Bus_capacity','$Fuel_condition','$state','$petrol','$maintenance','$cost')";



if ($conn->query($sql) === TRUE) {
  echo '<div class="my-class">'."New Bus Added Successfully" . '<br>'. '</div>';
