...
if ($f === 'Current')
{
	...
	if (mysqli_query($conn, $sql)) {
 		 echo '<div class="my-class">'."Trip Ended successfully".'<br>' .'</div>';
 		 echo '<div class="my-class">'."<a href='DriverHomepage.html' target='_blank'>Click here to go back</a>". '</div>';
	} else {
  	echo "Error updating record: " . mysqli_error($conn);
	}
}
else
{
	...
	#echo $check;
	echo '<div class="my-class">'."The Trip you entered has not started yet or already completed".'</div>';
}
