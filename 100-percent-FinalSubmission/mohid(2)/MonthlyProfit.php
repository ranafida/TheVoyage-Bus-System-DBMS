...
$revenue = $row['revenue'];
echo '<h3 class="heading">'."Monthly Profit".'</h3>';
...
$cost = $row2['cost'];
echo '<div class="my-class">'.'<span style="font-weight:bold;">'."Cost: ".'</span>'.$cost.'</div>';
...
echo '<div class="my-class">'.'<span style="font-weight:bold;">'."Salary: ".'</span>'.$cost2.'</div>';
...
echo '<div class="my-class">'.'<span style="font-weight:bold;">'."Profit: ".'</span>'.'<h3 style="font-weight:bold; padding="2px 0px";>'.$profit.'</h3>'.'</div>';
