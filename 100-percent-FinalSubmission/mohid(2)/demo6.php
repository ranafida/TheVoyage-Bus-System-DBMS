...
$sql = "INSERT INTO `driver` (driverID,busID,salary,drivingType,username,password,email,Message_rcv,Preference) VALUES ('$driverID', '$busID', '$salary', '$drivingType', '$username','$password', '$email','$msg','$pref')";



if ($conn->query($sql) === TRUE) {
  echo '<div class="my-class">'. "New record created successfully" . '<br>' .'</div>';
